    ...
    <>
      {!isVisible ? (
        <button
          ...
          className="fixed bottom-4 left-4 z-40 rounded-full border border-slate-300 bg-white px-4 py-2 text-xs font-semibold text-slate-700 shadow-md transition hover:bg-slate-50"
          aria-label="Cookie設定を開く"
        >
          Cookie設定
        </button>
      ) : null}
