  ...
  const faqData: FaqItem[] = [
    {
      ...
      answer:
        'ボイテキ！は「ボイテキクラウド！」と「ボイテキオンプレ！」を含む製品ファミリーです。音声データをAIで分析・要約・可視化し、応対品質向上と営業・組織運営の改善を支援します。',
    },
    {
      id: '2',
      question: 'ボイテキクラウド！の料金はいくらですか？',
      answer:
        'ボイテキクラウド！は月額基本料5,000円＋解析時間1時間あたり1,500円の従量課金制です（いずれも税抜）。従量課金の料金には外部AIサービス利用料も含まれ、初期費用・解約違約金はゼロです。',
    },
    {
      id: '3',
    ...
    },
    {
      ...
      answer:
        '月額基本料＋従量課金のシンプルな料金体系で、使った分だけ従量課金するためコスト効率が良好です。初期費用・解約違約金はゼロ。日本語特化で95%以上の高精度、バッチ処理による確実な分析、専任サポートにより、導入から運用まで一貫してサポートします。',
    },
    {
      id: '15',
