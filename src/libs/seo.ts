  ...
  faq: {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ボイテキ！（クラウド版）は月額基本料5,000円＋解析時間1時間あたり1,500円の従量課金制です（いずれも税抜）。従量課金の料金には外部AIサービス（ChatGPT、Gemini等）の利用料も含まれており、追加料金は発生しません。初期費用・解約違約金はゼロで、標準エンジンは無料でご利用いただけます。',
        },
      },
      {
        '@type': 'Question',
