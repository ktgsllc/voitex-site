      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mb-12 rounded-2xl bg-white p-8 shadow-lg">
          <div className="mb-8 text-center">
            <h2 className="mb-2 text-3xl font-bold text-gray-900">基本料金</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg bg-gray-50 p-6">
              ...
              <div className="space-y-2">
                <p className="text-sm text-gray-600">
                  実際の解析時間: <span className="font-medium">1時間50分</span>
                </p>
                <p className="text-sm text-gray-600">
            ...
            <div className="rounded-lg bg-gray-50 p-6">
              ...
              <div className="space-y-2">
                <p className="text-sm text-gray-600">
                  実際の解析時間: <span className="font-medium">2時間30分</span>
                </p>
                <p className="text-sm text-gray-600">
