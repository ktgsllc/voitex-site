...
const faqData: FaqItem[] = [
  ...
  // 料金・契約
  {
    ...
    answer:
      '月額基本料5,000円＋音声解析時間1時間あたり1,500円の従量課金制です（いずれも税抜）。解析を実施した音声の時間のみが従量課金の対象となり、録音時間や通話時間ではなく、実際に解析処理を行った時間に対して課金されます。ダッシュボードでリアルタイムに利用状況を確認できます。ご利用時間が安定しているお客様には、月額固定プランもご相談に応じます。',
    category: '料金・契約',
  },
  {
    id: '46',
  ...
  },
  {
    ...
    answer:
      '月額基本料5,000円＋解析時間1時間あたり1,500円の従量課金制です（いずれも税抜）。従量課金の料金には外部AIサービス（ChatGPT、Gemini等）の利用料も含まれており、追加料金は発生しません。初期費用・解約違約金はゼロで、標準エンジンは無料でご利用いただけます。※ 2026年5月1日より月額基本料を改定しました。',
    category: '料金・契約',
  },
  {
    id: '16',
    ...
    answer:
      '解約違約金はありません。月額基本料と、使用した分の従量課金をお支払いいただくだけで、いつでも解約可能です。',
    category: '料金・契約',
  },
  {
    id: '36',
    ...
    answer:
      'いいえ、必要ありません。ボイテキ！の従量課金（解析時間1時間あたり1,500円・税抜）には、外部AIサービス（ChatGPT、Gemini等）の利用料もすべて含まれています。追加料金は一切発生しません。',
    category: '料金・契約',
  },
  {
    id: '37',
