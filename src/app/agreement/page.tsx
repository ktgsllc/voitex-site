          ...
          <div className="mt-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <ul className="text-gray-600 space-y-2 ml-6 mb-4">
                <li>（1）本サービスを第三者に利用させる、または第三者のために利用すること（有償・無償を問いません）、または当社と競合する事業者が本サービスを利用すること</li>
                <li>（2）本件ソフトウェアを複製、改変、翻訳、翻案その他の形態で二次的著作物を作成すること、その他本件ソフトウェアの知的財産権を侵害すること</li>
                <li>（3）本件ソフトウェアを公衆送信すること</li>
                <li>（4）本件ソフトウェアを逆アセンブル、逆コンパイル、リバースエンジニアリングすること</li>
                <li>（5）本件ソフトウェアに含まれる著作権表示、商標その他の表示を除去または変更すること</li>
                <li>（6）当社が指定する手順以外の方法により本サービスにアクセスし、または本サービスを利用すること</li>
                <li>（7）本件ソフトウェアを譲渡し、または担保に供すること</li>
                <li>（8）本サービスまたは本件ソフトウェアと同様または類似のサービス、ソフトウェアを開発・販売するなど、これらに類する行為を行うこと</li>
                <li>（9）法令に違反し、または第三者の権利を侵害する態様で本サービスまたは本件ソフトウェアを利用すること</li>
                <li>（10）当社または第三者の設備の利用や事業、業務の運営・維持に支障を与える行為を行うこと</li>
                <li>（11）第三者になりすまして本サービスを利用すること</li>
                <li>（12）ウイルスなどの有害なプログラムを送信すること</li>
                <li>（13）当社または第三者に不利益を与える行為を行うこと</li>
                <li>（14）その他、本規約に違反する行為、不正な行為、または当社が不適切と合理的に判断する行為</li>
              </ul>
              <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <ul className="text-gray-600 space-y-2 ml-6 mb-4">
                <li>• 本サービスに必要な機器・設備などの点検、修理、保守、データ更新等が必要なとき</li>
                <li>• 機器・設備などの故障が発生したとき</li>
                <li>• 電気通信事業者が電気通信サービスの提供を停止・中止したとき</li>
                <li>• 火災、停電、天災地変その他の不可抗力（戦争、暴動、内乱、法令の制定改廃、公権力による命令処分、感染症の流行その他の緊急事態を含む）が発生したとき</li>
                <li>• 国または国の機関により営業の禁止や自粛等に関する命令または要請があったとき</li>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <ul className="text-gray-600 space-y-2 ml-6 mb-4">
                <li>• その請求等がなされた日から一定期間内に、利用者が当社に通知すること</li>
                <li>• 第三者との交渉または訴訟の遂行につき、当社に実質的な参加の機会と決定権限を与えること</li>
              </ul>
              <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <ul className="text-gray-600 space-y-2 ml-6 mb-4">
                <li>（1）本規約に違反し、当社が相当期間を定めて是正を催告したにもかかわらず是正しなかったとき</li>
                <li>（2）本規約に定める表明保証の内容が正確または真実でないことが判明したとき</li>
                <li>（3）申込書類に虚偽の記載があることが判明したとき</li>
                <li>（4）監督官庁より営業停止を命じられ、または営業免許若しくは営業登録の取消処分を受けたとき</li>
                <li>（5）支払停止若しくは支払不能の状態に陥ったとき、または手形や小切手が不渡りとなったとき</li>
                <li>（6）第三者より差押、仮差押、仮処分、競売の申立、または公租公課の滞納処分を受けたとき</li>
                <li>（7）破産手続開始、民事再生手続開始、会社更生手続開始、特別清算手続開始の申立を受け、または自ら申立を行ったとき</li>
                <li>（8）会社分割、事業の全部または重要な一部の事業譲渡、合併の決議をし、または解散の決議をしたとき</li>
                <li>（9）法令に違反したとき</li>
                <li>（10）資産または信用状態に重大な変化が生じ、またはその他の理由により本規約に基づく債務の履行が困難となるおそれがあると認められたとき（決済代行会社その他の第三者に対する本サービスの対価の決済が滞った場合を含みます）</li>
                <li>（11）6か月以上連続して本サービスの利用がなく対価も生じず、その他利用者に本サービスを利用する意思がないと認められるとき</li>
                <li>（12）利用者が死亡、または後見開始、保佐開始、補助開始の審判を受けたとき</li>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <ul className="text-gray-600 space-y-2 ml-6 mb-4">
                <li>（1）自らが暴力団、暴力団関係企業、総会屋その他これに準ずる者またはその構成員（以下総称して「反社会的勢力」といいます）ではなく、反社会的勢力に経営を支配されていないこと</li>
                <li>（2）自らの役員（取締役、執行役、執行役員、監査役またはこれらに準ずる者）が反社会的勢力ではないこと</li>
                <li>（3）反社会的勢力が自らの経営に実質的に関与していないこと</li>
                <li>（4）自らが反社会的勢力と社会的に非難される関係を有していないこと</li>
                <li>（5）反社会的勢力に自己の名義を利用させて本サービスの利用申込を行わないこと</li>
              </ul>
              <p className="text-gray-600 mb-4">
              ...
              <ul className="text-gray-600 space-y-2 ml-6 mb-4">
                ...
                <li>（4）風説を流布し、偽計または威力を用いて相手方の業務を妨害し、または信用を毀損する行為</li>
                <li>（5）自己または第三者の不正の利益を図る目的、または第三者に損害を加える目的で反社会的勢力を利用する行為</li>
                <li>（6）反社会的勢力に資金等を提供し、または便宜を供与する行為</li>
                <li>（7）前各号に準ずる行為</li>
              </ul>
              <p className="text-gray-600 mb-4">
                ...
                <table className="w-full border-collapse border border-gray-300">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="border border-gray-300 px-4 py-2 text-left">追加・適用開始日</th>
                      <th className="border border-gray-300 px-4 py-2 text-left">サービス名称</th>
                      <th className="border border-gray-300 px-4 py-2 text-left">備考</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2">2025年3月22日</td>
                      <td className="border border-gray-300 px-4 py-2">ボイテキ！/ボイテキ！コールサマライズ！</td>
                      <td className="border border-gray-300 px-4 py-2"></td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2">2025年6月1日</td>
                      <td className="border border-gray-300 px-4 py-2">ボイテキ！/QuickSum</td>
                      <td className="border border-gray-300 px-4 py-2">「ボイテキ！コールサマライズ！」をQuickSumに名称変更</td>
                    </tr>
                  </tbody>
                </table>
              </div>
